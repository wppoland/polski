...
- Name: checkout-checkboxes.spec.ts >> Checkout Legal Checkboxes >> checkout fails without accepting required checkboxes
- Location: tests/E2E/checkout-checkboxes.spec.ts:55:9
