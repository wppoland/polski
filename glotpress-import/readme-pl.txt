...
Tak. Polski dodaje pola produktów związane z GPSR, w tym dane producenta, importera i osoby odpowiedzialnej w UE, identyfikatory produktów, ostrzeżenia i instrukcje dotyczące bezpieczeństwa. Dane można wypełnić w edytorze produktów oraz zbiorczo poprzez import lub eksport CSV.
...
Polski nie jest kompletnym systemem do wysyłania faktur do KSeF, ale dodaje mechanizmy gotowe do integracji: flagowanie zamówień po NIP, kolumnę statusu KSeF oraz hooki do wtyczek do fakturowania i niestandardowych integracji.

= Does Polski issue invoices in WooCommerce? =

Polski udostępnia dane, flagi i hooki przydatne przy fakturowaniu i KSeF, jednak nie zastępuje pełnej wtyczki do fakturowania czy systemu księgowego. Do automatycznego fakturowania użyj dedykowanej integracji fakturowania.
...
Tak. Wtyczka umożliwia wyświetlanie cen jednostkowych, na przykład za kg, litr, metr, sztukę lub jednostkę niestandardową.
...
Tak. Polski rozszerza import i eksport CSV WooCommerce o wybrane dane produktów, w tym pola GPSR i inne informacje o produkcie.
