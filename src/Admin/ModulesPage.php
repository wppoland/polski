        ...
        $modules = [
            ...
            [
                ...
                'settings' => [
                    ...
                    ['key' => 'polski_datalayer|use_sku_as_id', 'label' => __('Use SKU as product ID', 'polski'), 'type' => 'checkbox', 'default' => false],
                ],
            ],
            [
                'id' => 'stock_export',
            ...
            [
                ...
                'settings' => [
                    ...
                    ['key' => 'polski_social_login|google_client_id', 'label' => __('Google Client ID', 'polski'), 'type' => 'text', 'default' => ''],
                    ['key' => 'polski_social_login|google_client_secret', 'label' => __('Google Client Secret', 'polski'), 'type' => 'text', 'default' => ''],
                    ['key' => 'polski_social_login|facebook_enabled', 'label' => __('Enable Facebook login', 'polski'), 'type' => 'checkbox', 'default' => false],
                    ['key' => 'polski_social_login|facebook_app_id', 'label' => __('Facebook App ID', 'polski'), 'type' => 'text', 'default' => ''],
                    ['key' => 'polski_social_login|facebook_app_secret', 'label' => __('Facebook App Secret', 'polski'), 'type' => 'text', 'default' => ''],
                    ['key' => 'polski_social_login|auto_register', 'label' => __('Auto-register new users', 'polski'), 'type' => 'checkbox', 'default' => true],
                ],
            ],
            [
                'id' => 'product_authors',
            ...
            [
                ...
                'links' => [],
                'settings' => [
                    ['key' => 'polski_social_proof|display_interval', 'label' => __('Interval between popups (seconds)', 'polski'), 'type' => 'number', 'default' => 8],
                    ['key' => 'polski_social_proof|display_duration', 'label' => __('Display duration (seconds)', 'polski'), 'type' => 'number', 'default' => 5],
                    ...
                    ['key' => 'polski_social_proof|anonymize_name', 'label' => __('Anonymize customer names', 'polski'), 'type' => 'checkbox', 'default' => false],
                    ['key' => 'polski_social_proof|hide_on_mobile', 'label' => __('Hide on mobile devices', 'polski'), 'type' => 'checkbox', 'default' => false],
                ],
            ],
            [
                'id' => 'product_qa',
            ...
            [
                ...
                'links' => [],
                'settings' => [
                    ['key' => 'polski_price_history|days', 'label' => __('History period (days)', 'polski'), 'type' => 'number', 'default' => 30],
                    ['key' => 'polski_price_history|show_min_max', 'label' => __('Show min/max prices', 'polski'), 'type' => 'checkbox', 'default' => true],
                    ['key' => 'polski_price_history|color', 'label' => __('Line color', 'polski'), 'type' => 'text', 'default' => '#0369a1'],
                ],
            ],
            [
                'id' => 'order_export',
