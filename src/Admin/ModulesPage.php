...
final class ModulesPage implements HasHooks
{
    ...
    public function getModules(): array
    {
        ...
        $modules = [
            ...
            [
                'id' => 'invoices',
                'name' => __('VAT invoices', 'polski'),
                'description' => __('Issue a numbered VAT invoice for an order and let the customer open it from My Account. Sequential numbering per year, VAT grouped by rate, laid out for printing or saving as a PDF from the browser.', 'polski'),
                'group' => 'Checkout and Orders',
                'enabled' => false,
                'pro' => false,
                ...
                'links' => [],
                'settings' => [
                    ['key' => 'polski_invoices|series', 'label' => __('Number series', 'polski'), 'type' => 'text', 'default' => 'FV', 'hint' => __('Invoices are numbered SERIES/N/YEAR, restarting at 1 each year.', 'polski')],
                    ['key' => 'polski_invoices|due_days', 'label' => __('Payment terms (days)', 'polski'), 'type' => 'number', 'default' => 0, 'hint' => __('0 leaves the due date off the invoice, which suits a shop that is paid before dispatch.', 'polski')],
                ],
            ],
            [
                'id' => 'consent_logging',
            ...
            [
                ...
                'name' => __('Legal texts in emails', 'polski'),
                'description' => __('Appends the text of your legal pages (terms, privacy policy, right of withdrawal) to the bottom of WooCommerce customer emails. The text is part of the message body; no file is attached.', 'polski'),
                'group' => 'Consumer Rights',
                'enabled' => true,
                'icon' => 'dashicons-email',
                'links' => [],
                'settings' => [
                    ['key' => 'polski_emails|attach_terms', 'label' => __('Include Terms and Conditions', 'polski'), 'type' => 'checkbox', 'default' => true],
                    ['key' => 'polski_emails|attach_privacy', 'label' => __('Include Privacy Policy', 'polski'), 'type' => 'checkbox', 'default' => false],
                    ['key' => 'polski_emails|attach_withdrawal', 'label' => __('Include Right of Withdrawal', 'polski'), 'type' => 'checkbox', 'default' => true],
                ],
            ],
