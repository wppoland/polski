...
final class Migration_2_2_0 implements Migration
{
    ...
    public function run(): void
    {
        ...
        foreach ($indexes as $name => $definition) {
            ...
            // phpcs:ignore WordPress.DB.DirectDatabaseQuery.DirectQuery,WordPress.DB.DirectDatabaseQuery.NoCaching,WordPress.DB.PreparedSQL.InterpolatedNotPrepared -- ALTER TABLE, identifiers whitelisted above.
